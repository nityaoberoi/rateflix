...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Movie.release_year'
        db.alter_column('rateflix_movie', 'release_year', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        'rateflix.movie': {
            ...
            'release_year': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True'})
        },
